const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DashboardPage-BteyG36N.js","assets/StatusBadge-BLrMRFeS.js","assets/card-BMuEzBa3.js","assets/table-DbJbCY2k.js","assets/helpers-DPF4kehq.js","assets/CustomersPage-KchmQb9r.js","assets/input-CFmIcUl7.js","assets/OrdersPage-CF8KYGUQ.js","assets/select-BtldO34S.js","assets/MeasurementsPage-Ciq7DdFp.js","assets/AppointmentsPage-BSHjQEsY.js","assets/FabricInventoryPage-Q6HsFSt2.js","assets/BillingPage-xYoL7Hv8.js","assets/StaffPage-MbQOYLxf.js"])))=>i.map(i=>d[i]);
...
class LocalBackend {
  async seedData() {
    ...
    const customers = customerData.map((d) => ({
  ...
  async getOrdersByCustomer(customerId) {
    return load(KEYS.orders).filter((o) => o.customerId === customerId);
  }
  ...
  async addInventoryItem(fabricName, color, quantityMeters, pricePerMeter, supplier, reorderLevel) {
    const inventory = load(KEYS.inventory);
    const item = {
      id: nextId(KEYS.nextInventoryId),
      fabricName,
      color,
  ...
  async addStaff(name, role, phone, email, department, joinDate, address) {
    const staffList = load(KEYS.staff);
...
const DashboardPage = reactExports.lazy(() => __vitePreload(() => import("./DashboardPage-BteyG36N.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const CustomersPage = reactExports.lazy(() => __vitePreload(() => import("./CustomersPage-KchmQb9r.js"), true ? __vite__mapDeps([5,6,2,3]) : void 0));
const OrdersPage = reactExports.lazy(() => __vitePreload(() => import("./OrdersPage-CF8KYGUQ.js"), true ? __vite__mapDeps([7,1,6,2,8,3,4]) : void 0));
const MeasurementsPage = reactExports.lazy(() => __vitePreload(() => import("./MeasurementsPage-Ciq7DdFp.js"), true ? __vite__mapDeps([9,2]) : void 0));
const AppointmentsPage = reactExports.lazy(() => __vitePreload(() => import("./AppointmentsPage-BSHjQEsY.js"), true ? __vite__mapDeps([10,1,6,2,8,3,4]) : void 0));
const FabricInventoryPage = reactExports.lazy(() => __vitePreload(() => import("./FabricInventoryPage-Q6HsFSt2.js"), true ? __vite__mapDeps([11,6,2,3,4]) : void 0));
const BillingPage = reactExports.lazy(() => __vitePreload(() => import("./BillingPage-xYoL7Hv8.js"), true ? __vite__mapDeps([12,1,6,2,8,3,4]) : void 0));
const StaffPage = reactExports.lazy(() => __vitePreload(() => import("./StaffPage-MbQOYLxf.js"), true ? __vite__mapDeps([13,6,2]) : void 0));
const navItems = [
...
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-[#1F7E78]" }) });
}
function App() {
  const [activeNav, setActiveNav] = reactExports.useState("Dashboard");
  reactExports.useEffect(() => {
    if (!localStorage.getItem("tailorpro_seeded")) {
      backend.seedData().then(() => localStorage.setItem("tailorpro_seeded", "1"));
    }
  }, []);
          ...
          "header",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-xl tracking-tight", children: "TailorPro" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-[#1F7E78] flex items-center justify-center text-white text-sm font-bold", children: "T" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#EAF0F6] text-sm", children: "Shop Owner" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "w-[220px] bg-white border-r border-gray-200 flex flex-col shrink-0 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "py-4", children: navItems.map(({ label, icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto bg-[#F4F6F8] p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: [
            ...
            activeNav === "Staff" && /* @__PURE__ */ jsxRuntimeExports.jsx(StaffPage, {})
          ] }) })
        ] })
      ]
    }
