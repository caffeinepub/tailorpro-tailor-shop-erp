const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DashboardPage-hSdvWc9-.js","assets/StatusBadge-DqmAI6X8.js","assets/card-CJvQvCJx.js","assets/table-BzwvrkY5.js","assets/helpers-DPF4kehq.js","assets/CustomersPage-BFYyiFRM.js","assets/dialog-Cb9Fqp_3.js","assets/OrdersPage-I17dbUFq.js","assets/select-D9rDSH8s.js","assets/index-CBgo5G70.js","assets/textarea-CRaVsNYH.js","assets/MeasurementsPage-D73L7g1E.js","assets/AppointmentsPage-COZCcRM0.js","assets/FabricInventoryPage-ZASQ8DxB.js","assets/BillingPage-Cyv39VQN.js","assets/StaffPage-CIN4yMVL.js"])))=>i.map(i=>d[i]);
...
async function idbGet(store, key) {
  ...
  return new Promise((resolve, reject) => {
    ...
    req.onsuccess = () => {
      var _a2;
      return resolve(((_a2 = req.result) == null ? void 0 : _a2.value) ?? void 0);
    };
...
const BIGINT_FIELDS = /* @__PURE__ */ new Set([
  "id",
  "customerId",
  "orderId",
  "createdAt",
...
function deserialize(json) {
  return JSON.parse(json, (key, value) => {
    if (typeof value === "string" && value.endsWith("n") && /^\d+n$/.test(value) && BIGINT_FIELDS.has(key)) {
...
const dateOffset = (days) => BigInt(Date.now() + days * 864e5) * 1000000n;
function makeStaffId(num) {
  const n = Number(num);
...
class LocalBackend {
  ...
  async addCustomer(name, phone, email, address, measurements) {
    const customers = await load(KEYS.customers);
    const customer = {
      id: await nextId(KEYS.nextCustomerId),
      name,
      phone,
  ...
  async updateCustomer(id, name, phone, email, address, measurements) {
    const customers = await load(KEYS.customers);
  ...
  async getDashboardStats() {
    ...
    const todayEndNs = BigInt(todayEnd.getTime()) * 1000000n;
    ...
    const monthStartNs = BigInt(monthStart.getTime()) * 1000000n;
    const monthlyRevenue = orders.filter((o) => o.createdAt >= monthStartNs && "Delivered" in o.status).reduce((sum, o) => sum + o.price, 0);
    return {
  ...
  async getOrdersByCustomer(customerId) {
    const orders = await load(KEYS.orders);
    return orders.filter((o) => String(o.customerId) === String(customerId));
  }
  async addOrder(customerId, customerName, garmentType, fabricName, fabricColor, quantity, price, advancePaid, dueDate, notes) {
    const orders = await load(KEYS.orders);
    const order = {
  ...
  async addAppointment(customerId, customerName, dateTime, appointmentType, notes) {
    const appointments = await load(KEYS.appointments);
    const appointment = {
  ...
  async addInventoryItem(fabricName, color, quantityMeters, pricePerMeter, supplier, reorderLevel) {
    const inventory = await load(KEYS.inventory);
    const item = {
  ...
  async updateInventoryItem(id, fabricName, color, quantityMeters, pricePerMeter, supplier, reorderLevel) {
    const inventory = await load(KEYS.inventory);
  ...
  async createInvoice(orderId, customerId, customerName, subtotal, discount, tax, total, paymentMethod) {
    const invoices = await load(KEYS.invoices);
    const invoice = {
  ...
  async addStaff(name, role, phone, email, department, joinDate, address) {
    const staffList = await load(KEYS.staff);
    const id = await nextId(KEYS.nextStaffId);
  ...
  async updateStaff(id, name, role, phone, email, department, joinDate, address) {
    const staffList = await load(KEYS.staff);
...
function StaffLoginPage({ onLogin }) {
  const [tab, setTab] = reactExports.useState("owner");
  ...
  const [ownerLoading, setOwnerLoading] = reactExports.useState(false);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "header",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-xl tracking-tight", children: "Ali Tailor" })
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm bg-white rounded-2xl shadow-lg overflow-hidden", children: [
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: tab === "owner" ? "👑" : "🔒" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-bold text-xl", children: tab === "owner" ? "Owner Login" : "Staff Login" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "text-sm mt-1",
                    style: { color: "rgba(234,240,246,0.7)" },
                    children: tab === "owner" ? "Full access to all features" : "Enter your credentials to continue"
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex border-b border-gray-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `flex-1 py-3 text-sm font-semibold transition-colors ${tab === "owner" ? "text-[#1F7E78] border-b-2 border-[#1F7E78] bg-[#f0fafa]" : "text-gray-500 hover:bg-gray-50"}`,
                children: "👑 Owner"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `flex-1 py-3 text-sm font-semibold transition-colors ${tab === "staff" ? "text-[#1F7E78] border-b-2 border-[#1F7E78] bg-[#f0fafa]" : "text-gray-500 hover:bg-gray-50"}`,
                children: "👤 Staff"
              }
            )
          ] }),
          tab === "owner" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleOwnerSubmit, className: "px-8 py-6 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400 mt-1", children: [
                "Default: mobile ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "9999999999" }),
                ", password",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "owner@123" })
              ] })
            ] }),
            ownerError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-red-600 bg-red-50 rounded-lg px-3 py-2", children: ownerError }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                type: "submit",
                ...
                children: ownerLoading ? "Signing in..." : "Sign In as Owner"
              }
            )
          ] }),
          tab === "staff" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleStaffSubmit, className: "px-8 py-6 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "label",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-1", children: "First-time login? Leave password blank or enter any password." })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-8 pb-5 text-center text-xs text-gray-400", children: [
            "Ali Tailor ERP · ",
            tab === "owner" ? "Owner Portal" : "Staff Portal"
          ] })
        ] }) }),
...
const DashboardPage = reactExports.lazy(() => __vitePreload(() => import("./DashboardPage-hSdvWc9-.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const CustomersPage = reactExports.lazy(() => __vitePreload(() => import("./CustomersPage-BFYyiFRM.js"), true ? __vite__mapDeps([5,2,6,3]) : void 0));
const OrdersPage = reactExports.lazy(() => __vitePreload(() => import("./OrdersPage-I17dbUFq.js"), true ? __vite__mapDeps([7,1,2,6,8,9,3,10,4]) : void 0));
const MeasurementsPage = reactExports.lazy(() => __vitePreload(() => import("./MeasurementsPage-D73L7g1E.js"), true ? __vite__mapDeps([11,2]) : void 0));
const AppointmentsPage = reactExports.lazy(() => __vitePreload(() => import("./AppointmentsPage-COZCcRM0.js"), true ? __vite__mapDeps([12,1,2,6,8,9,3,4]) : void 0));
const FabricInventoryPage = reactExports.lazy(() => __vitePreload(() => import("./FabricInventoryPage-ZASQ8DxB.js"), true ? __vite__mapDeps([13,2,6,3,4]) : void 0));
const BillingPage = reactExports.lazy(() => __vitePreload(() => import("./BillingPage-Cyv39VQN.js"), true ? __vite__mapDeps([14,1,2,6,8,9,3,10,4]) : void 0));
const StaffPage = reactExports.lazy(() => __vitePreload(() => import("./StaffPage-CIN4yMVL.js"), true ? __vite__mapDeps([15,2,6,3,9]) : void 0));
const OwnerSettingsPage = reactExports.lazy(() => __vitePreload(() => import("./OwnerSettingsPage-CfdMKA_3.js"), true ? [] : void 0));
const staffNavItems = [
...
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full min-h-[200px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-[#1F7E78]" }) });
}
...
function App() {
  ...
  const [loggedInStaff, setLoggedInStaff] = reactExports.useState(null);
  const [isOwner, setIsOwner] = reactExports.useState(false);
  const [ownerName, setOwnerName] = reactExports.useState("Shop Owner");
  const [isInitializing, setIsInitializing] = reactExports.useState(true);
  const [showMoreDrawer, setShowMoreDrawer] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const init = async () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-2xl tracking-tight", children: "Ali Tailor" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-10 w-10 border-b-2 border-[#1F7E78] mt-2" })
        ]
      }
    );
  }
  ...
  if (!isLoggedIn) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(StaffLoginPage, { onLogin: handleLogin });
  }
  const displayName = isOwner ? ownerName : (loggedInStaff == null ? void 0 : loggedInStaff.name) ?? "";
    ...
    "div",
    {
      ...
      children: [
          ...
          "header",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-base md:text-xl tracking-tight", children: "Ali Tailor" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 md:gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "👑" }),
                      !isOwner && getInitials(displayName)
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:block text-[#EAF0F6] text-sm", children: displayName }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden md:flex w-[220px] bg-white border-r border-gray-200 flex-col shrink-0 overflow-y-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "py-4", children: navItems.map(({ label, icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                onClick: () => navigateTo(label),
                "data-ocid": `nav.${label.toLowerCase()}.link`,
                className: `w-full flex items-center gap-3 px-5 py-3 text-sm font-medium transition-colors ${activeNav === label ? "bg-[#EEF2F5] text-[#1F7E78] border-r-2 border-[#1F7E78]" : "text-[#374151] hover:bg-gray-50"}`,
                children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto px-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: isOwner ? "👑 Owner Access" : "👤 Staff Access"
              }
            ) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto bg-[#F4F6F8] px-3 py-4 md:p-6 pb-24 md:pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: [
            activeNav === "Dashboard" && /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardPage, {}),
            activeNav === "Customers" && /* @__PURE__ */ jsxRuntimeExports.jsx(CustomersPage, {}),
            activeNav === "Orders" && /* @__PURE__ */ jsxRuntimeExports.jsx(OrdersPage, {}),
            activeNav === "Measurements" && /* @__PURE__ */ jsxRuntimeExports.jsx(MeasurementsPage, {}),
            activeNav === "Appointments" && /* @__PURE__ */ jsxRuntimeExports.jsx(AppointmentsPage, {}),
            activeNav === "Inventory" && /* @__PURE__ */ jsxRuntimeExports.jsx(FabricInventoryPage, {}),
            activeNav === "Billing" && /* @__PURE__ */ jsxRuntimeExports.jsx(BillingPage, {}),
            activeNav === "Staff" && isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(StaffPage, {}),
            activeNav === "Settings" && isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(OwnerSettingsPage, {})
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "nav",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    (isMoreActive || showMoreDrawer) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: "absolute bottom-0 w-10 h-0.5 rounded-t-full",
                        style: { background: "#1F7E78" }
        ...
        showMoreDrawer && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              role: "presentation",
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-gray-100", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-gray-700 text-sm", children: "More" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-2", children: moreItems.map(({ label, icon }) => {
                  const isActive = activeNav === label;
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      className: `w-full flex items-center gap-4 px-5 py-4 text-sm font-medium transition-colors ${isActive ? "bg-[#f0fdfb] text-[#1F7E78]" : "text-[#374151] hover:bg-gray-50"}`,
                      children: [
